...
export async function POST(req: NextRequest) {
  ...
  const { keyword, location, maxLeads, intervalMinutes, extraKeywords, extraKeywordsMode, extraKeywordsMin, extraKeywordsMax } = body;
  ...
  const kw = await createKeyword({ keyword, location, maxLeads, intervalMinutes, extraKeywords, extraKeywordsMode, extraKeywordsMin, extraKeywordsMax, createdById: userId });
