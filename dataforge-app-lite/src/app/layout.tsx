...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Apply Lite Mode before first paint so there's no flash of animation. */}
        <script
          dangerouslySetInnerHTML={{
            __html: "try{if(localStorage.getItem('df-lite-mode')==='1')document.documentElement.setAttribute('data-lite','1')}catch(e){}",
          }}
        />
