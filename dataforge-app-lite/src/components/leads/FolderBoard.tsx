...
import { FolderExportBar } from "./FolderExportBar";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hover hint + export indicator */}
        <div className="flex items-center justify-between gap-2">
          <p className="text-[11px] font-medium" style={{ color: folder.color }}>
            Click to view leads →
          </p>
          <FolderExportBar exported={folder.exportedCount ?? 0} total={folder._count.leads} color={folder.color} />
        </div>
      </button>
    </div>
  );
